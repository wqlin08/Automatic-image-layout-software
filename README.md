...
> **No need for manual image arrangement**  
> **无需再手动组图排版**
...
If **AutoGrid** saved your time on your paper, please give me a **Star**, thanks ! ! !
...
**AutoGrid** 是一款专为科研人员和学生（计算机视觉/遥感/医学影像等方向）设计的 Windows 工具。能自动完成学术论文中多图组合的排版工作。与 PowerPoint 或 Photoshop 不同，只需几次点击，即可保证图片完美对齐、间距均匀以及标签风格统一。
...
如果 **AutoGrid** 帮你节省了写论文的时间，请给我点一个 **Star**，谢谢！！！
